...
const Contact = () => {
    ...
    formData.append("access_key", "589e655a-a990-4bd6-a14d-4100d0bf7562");
  ...
  return (
    <motion.div 
      ...
      id='contact' className='w-full px-[12%] py-10 scroll-mt-24 
    bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-size-[90%_auto] pb-20 dark:bg-none'>
      <motion.h4 
        initial={{ opacity: 0, y: -20 }}
        whileInView={{ opacity: 1, y: 0}}
        transition={{ duration: 0.5, delay: 0.3 }}
        className='text-center mb-2 text-lg font-Ovo'>
        Let's Talk Code & Carrots
      </motion.h4>
      <motion.h2 
        initial={{ opacity: 0, y: -20 }}
        whileInView={{ opacity: 1, y: 0}}
      ...
      <motion.p 
        ...
        I'm always eager to collaborate, discuss new tech, or answer any questions you may have. Feel free to reach out - I promise a quick hop back to your inbox!
    </motion.p>
    <motion.form 
      initial={{ opacity: 0 }}
      whileInView={{ opacity: 1}}
